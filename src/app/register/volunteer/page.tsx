...
import { volunteerRoles, departments } from "@/lib/types";
import { volunteerSchema, type VolunteerSchema as VolunteerFormValues } from "@/lib/schemas";
...
export default function VolunteerRegistrationPage() {
  ...
  const form = useForm<VolunteerFormValues>({
    resolver: zodResolver(volunteerSchema.omit({ photoUrl: true, jobFairId: true })),
    defaultValues: {
      fullName: "",
      registrationNumber: "",
      semester: "",
      ...
      preferredRole: "Student Guidance"
    },
  });
  ...
  async function onSubmit(data: VolunteerFormValues) {
    ...
    try {
      ...
      const { password, ...volunteerData } = data;
      await setDoc(doc(firestore, "volunteers", user.uid), {
        ...volunteerData,
        id: user.uid,
        userProfileId: user.uid,
        jobFairId: "main-job-fair-2024", // Hardcoded for single-event app
        status: "pending",
        createdAt: serverTimestamp(),
      });
      ...
      toast({
        ...
        description: "Please check your inbox to verify your email. Your application is pending approval.",
      });
      router.push("/login");
    } catch (error: any) {
  ...
  return (
     <div className="container mx-auto max-w-2xl py-12">
        ...
        <CardHeader>
            ...
            <CardDescription>Fill out the form below to join our team of volunteers for the event.</CardDescription>
        </CardHeader>
        <CardContent>
            <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <FormField
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                        <Input placeholder="e.g., 6th" {...field} />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                    )}
                ...
                <FormField
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                        <Input placeholder="you@case.edu.pk" type="email" {...field} />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                    )}
